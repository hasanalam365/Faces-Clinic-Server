...
const bookConsultation = async (req, res) => {
  try {
    const { name, email, phone, treatment, date, notes } = req.body;
...
New "Book a Consultation" Request
</p>
...
<td width="170" style="color:#3fe6cf;"><strong>Name</strong></td>
<td>${name}</td>
</tr>
...
<tr>
<td style="color:#3fe6cf;"><strong>Treatment</strong></td>
<td>${treatment || "Not specified"}</td>
</tr>

<tr style="background:#151b1e;">
<td style="color:#3fe6cf;"><strong>Preferred Date</strong></td>
...
`,
    ...
    const userMail = transporter.sendMail({
      ...
      subject: `We've received your consultation request, ${name}!`,
      html: `
<!DOCTYPE html>
<html>
<head>
...
A member of our clinic team will call or email you shortly to confirm.
</p>
...
<tr>
<td style="color:#3fe6cf;"><strong>Treatment</strong></td>
<td style="color:#ffffff;">${treatment || "Not specified"}</td>
</tr>

<tr style="background:#151b1e;">
<td style="color:#3fe6cf;"><strong>Preferred Date</strong></td>
<td style="color:#ffffff;">${date || "Not specified"}</td>
</tr>
...
line-height:1.8;
">
Our clinic team will review your request and contact you as soon as possible.
...
`,
    ...
    console.error("❌ Consultation booking error:", error.message);
